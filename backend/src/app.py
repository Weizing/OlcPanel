...
def add_node():
    ...
    # Generate docker-compose.yml for the node with inline Dockerfile
...
"""
    ...
    # Generate node_api.py content
    node_api_content = '''import os
import json
import docker
...
'''
    ...
    node['node_api'] = node_api_content
...
2. Создайте файл node_api.py с содержимым выше
